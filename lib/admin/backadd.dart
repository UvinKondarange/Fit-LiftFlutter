...
class backAdd extends StatefulWidget {
  @override
  _backAddState createState() => _backAddState();
}

class _backAddState extends State<backAdd> {
  ...
  CollectionReference collectionReference =
      Firestore.instance.collection('workout plans2');

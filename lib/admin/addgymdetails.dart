...
class addGymDetails extends StatefulWidget {
  @override
  _addGymDetailsState createState() => _addGymDetailsState();
}

class _addGymDetailsState extends State<addGymDetails> {
  ...
  CollectionReference collectionReference =
      Firestore.instance.collection('gym info');

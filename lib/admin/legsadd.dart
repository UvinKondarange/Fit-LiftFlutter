...
class legsAdd extends StatefulWidget {
  @override
  _legsAddState createState() => _legsAddState();
}

class _legsAddState extends State<legsAdd> {
  ...
  CollectionReference collectionReference =
      Firestore.instance.collection('workout plans5');

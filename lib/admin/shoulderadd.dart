...
class shoulderAdd extends StatefulWidget {
  @override
  _shoulderAddState createState() => _shoulderAddState();
}

class _shoulderAddState extends State<shoulderAdd> {
  ...
  CollectionReference collectionReference =
      Firestore.instance.collection('workout plan4');

...
class bicepAdd extends StatefulWidget {
  @override
  _bicepAddState createState() => _bicepAddState();
}

class _bicepAddState extends State<bicepAdd> {
  ...
  CollectionReference collectionReference =
      Firestore.instance.collection('workout plans1');

...
class tricepAdd extends StatefulWidget {
  @override
  _tricepAddState createState() => _tricepAddState();
}

class _tricepAddState extends State<tricepAdd> {
  ...
  CollectionReference collectionReference =
      Firestore.instance.collection('workout plans3');
